...
public class AuthorsEntity {
  ...
  @BsonProperty("authorAliases")
  
  private List<String> authorAliases = new ArrayList<>();
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, authors.id) &&
        ...
        Objects.equals(this.authorAliases, authors.authorAliases);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, sanitizedName, bio, books, authorAliases);
  }
  ...
  public String toString() {
    ...
    sb.append("    authorAliases: ").append(toIndentedString(authorAliases)).append("\n");
    sb.append("}");
    return sb.toString();
  }
